...
public class ToolController {
    ...
    @Operation(
            ...
            description = "Возвращает список всех инструментов. Доступно для ролей ADMIN и STOREKEEPER."
    )
    @ApiResponses(
            value = {
    ...
    @Operation(
            ...
            description = "Возвращает список инструментов с пагинацией. Доступно для ролей ADMIN и STOREKEEPER."
    )
    @ApiResponses(
            value = {
                    @ApiResponse(responseCode = "200", description = "Список инструментов успешно получен."),
    ...
    @Operation(
            ...
            description = "Возвращает инструмент по ID. Доступно для ролей ADMIN и STOREKEEPER."
    )
    @ApiResponses(
            value = {
    ...
    @Operation(
            ...
            description = "Возвращает список инструментов по типу. Доступно для ролей ADMIN и STOREKEEPER."
    )
    @ApiResponses(
            value = {
                    @ApiResponse(responseCode = "200", description = "Список инструментов успешно получен."),
    ...
    @Operation(
            ...
            description = "Возвращает список инструментов по месту хранения. Доступно для ролей ADMIN и STOREKEEPER."
    )
    @ApiResponses(
            value = {
                    @ApiResponse(responseCode = "200", description = "Список инструментов успешно получен."),
