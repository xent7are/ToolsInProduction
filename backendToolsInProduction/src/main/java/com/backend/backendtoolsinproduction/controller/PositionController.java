...
public class PositionController {
    ...
    public ResponseEntity<?> createPosition(
        ...
        try {
            ...
            Position newPosition = positionService.createPosition(titlePosition, requirements, duties, salary, Position.Role.valueOf(role));
    ...
    // Обновление должности по идентификатору с обработкой ошибок
    @Operation(
    ...
    public ResponseEntity<?> updatePosition(
        ...
        try {
            ...
            Position updatedPosition = positionService.updatePosition(id, titlePosition, requirements, duties, salary,
                    role != null ? Position.Role.valueOf(role) : null);
    ...
    // Удаление должности по идентификатору с обработкой ошибок
    @Operation(
    ...
    public ResponseEntity<?> deletePosition(
            ...
            @PathVariable String id) {
        try {
            // Удаление должности по идентификатору через сервис
