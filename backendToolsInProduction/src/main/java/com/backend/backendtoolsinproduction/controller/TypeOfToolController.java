...
public class TypeOfToolController {
    ...
    @Operation(
            ...
            description = "Создает новый тип инструмента. Доступно для ролей ADMIN и STOREKEEPER."
    )
    @ApiResponses(
            value = {
    ...
    public ResponseEntity<?> createTypeOfTool(
        ...
        try {
            // Создание нового типа инструмента через сервис
            TypeOfTool newTypeOfTool = typeOfToolService.createTypeOfTool(name, description);
